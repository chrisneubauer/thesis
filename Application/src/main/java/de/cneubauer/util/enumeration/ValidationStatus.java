...
public enum ValidationStatus {
    ...
    MISSINGPOSITION,
    MISSINGVALUES,
    MISSINGINVOICENO, MISSINGCREDITOR, MISSINGDEBITOR, MALFORMEDISSUEDATE, NOLINETOTALVALUE, NOCHARGETOTALVALUE, NOTAXBASISVALUE, NOTAXTOTAL, NOALLOWANCETOTAL, NOGRANDTOTAL, SKONTOSELECTEDBUTNOTVALUE, MALFORMEDDELIVERYDATE, UNKNOWNISSUE
}