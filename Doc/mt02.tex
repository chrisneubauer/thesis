...
Future Potential & \cellcolor[HTML]{34FF34}\begin{tabular}[c]{@{}c@{}}New Version\\ twice a year\end{tabular} & \cellcolor[HTML]{34FF34}\begin{tabular}[c]{@{}c@{}}Version 2.1 (2013),\\ Version 3 already\\ exists as a draft\end{tabular} & \cellcolor[HTML]{34FF34}\begin{tabular}[c]{@{}c@{}}Version 1.0 (2016),\\ Version 2.0 \\ announced for 2017\end{tabular} & \cellcolor[HTML]{FE0000}Version 2.0 (2007) \\ \midrule
\begin{tabular}[c]{@{}l@{}}Relevance in Germany\\ (and Europe)\end{tabular} & \cellcolor[HTML]{34FF34}\begin{tabular}[c]{@{}c@{}}International relevance \\ due to a lot of users. \\ Not specialized on Germany\end{tabular} & \cellcolor[HTML]{34FF34}\begin{tabular}[c]{@{}c@{}}Initially used in \\ Denmark, main \\ usage in Europe\end{tabular} & \cellcolor[HTML]{34FF34}\begin{tabular}[c]{@{}c@{}}Highly relevant,\\ especially in \\ Germany but also\\ in Europe\end{tabular} & \cellcolor[HTML]{FFFE65}\begin{tabular}[c]{@{}c@{}}Relevant in Germany\\ due to big\\ automotive \\ companies\\ and their suppliers\end{tabular} \\ \midrule
Complexity & \cellcolor[HTML]{FE0000}\begin{tabular}[c]{@{}c@{}}Highly complex \\ due to the many \\ possible options \\ and message types\end{tabular} & \cellcolor[HTML]{FFFE65}\begin{tabular}[c]{@{}c@{}}Complex (normal UBL)\\ or simpler \\ (Small Business Subset)\end{tabular} & \cellcolor[HTML]{34FF34}\begin{tabular}[c]{@{}c@{}}Depending on the\\ use case \\ from simple\\ to complex\end{tabular} & \cellcolor[HTML]{FFFE65}N.A. \\ \bottomrule
\end{tabular}%
}
