...
Even though EDIFACT has an international relevance and a high future potential, the complexity of the standard makes it hard to support it completely. Since we have a limited time for the creation of this thesis, we will not support the EDIFACT standard\footnote{But it would be a possible improvement of the application for the future (see also section \ref{sec6.3.4})}. 
